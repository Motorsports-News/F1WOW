...
const CHAMPIONSHIP_DATA_2026 = {
    driver: {
        ...
        kimiAntonelli: { name: 'Kimi Antonelli', team: 'Mercedes', color: '#27F4D2', points: [18, 47, 75, 100, 131, 131] },
        georgeRussell: { name: 'George Russell', team: 'Mercedes', color: '#27F4D2', points: [25, 43, 58, 70, 88, 88] },
        charlesLeclerc: { name: 'Charles Leclerc', team: 'Ferrari', color: '#F91536', points: [15, 27, 40, 50, 75, 75] },
        lewisHamilton: { name: 'Lewis Hamilton', team: 'Ferrari', color: '#F91536', points: [12, 27, 42, 54, 72, 97] },
        landoNorris: { name: 'Lando Norris', team: 'McLaren', color: '#FF8700', points: [10, 15, 25, 35, 58, 58] },
        oscarPiastri: { name: 'Oscar Piastri', team: 'McLaren', color: '#FF8700', points: [8, 13, 23, 33, 48, 48] },
        maxVerstappen: { name: 'Max Verstappen', team: 'Red Bull Racing', color: '#3671C6', points: [6, 8, 12, 22, 43, 43] },
        pierreGasly: { name: 'Pierre Gasly', team: 'Alpine', color: '#FF87BC', points: [8, 9, 12, 15, 20, 20] },
        oliverBearman: { name: 'Oliver Bearman', team: 'Haas F1 Team', color: '#B6BABD', points: [10, 17, 22, 27, 18, 18] },
        liamLawson: { name: 'Liam Lawson', team: 'Racing Bulls', color: '#5E8FAA', points: [5, 8, 10, 13, 16, 16] },
        francoColapinto: { name: 'Franco Colapinto', team: 'Alpine', color: '#FF87BC', points: [2, 4, 8, 12, 15, 15] },
        isackHadjar: { name: 'Isack Hadjar', team: 'Red Bull Racing', color: '#3671C6', points: [4, 5, 7, 10, 14, 14] },
        carlosSainz: { name: 'Carlos Sainz', team: 'Williams', color: '#64C4FF', points: [4, 2, 6, 8, 6, 6] },
        alexAlbon: { name: 'Alexander Albon', team: 'Williams', color: '#64C4FF', points: [2, 4, 6, 8, 1, 1] },
        estebanOcon: { name: 'Esteban Ocon', team: 'Haas F1 Team', color: '#B6BABD', points: [2, 0, 2, 4, 1, 1] },
        arvidLindblad: { name: 'Arvid Lindblad', team: 'Racing Bulls', color: '#5E8FAA', points: [2, 3, 4, 5, 5, 5] },
        gabrielBortoleto: { name: 'Gabriel Bortoleto', team: 'Audi', color: '#C92D4B', points: [1, 2, 2, 2, 2, 2] },
        nicoHulkenberg: { name: 'Nico Hulkenberg', team: 'Audi', color: '#C92D4B', points: [2, 2, 2, 2, 0, 0] }
    },
    constructor: {
        rounds: ['Australia', 'China', 'Japan', 'Miami', 'Canada', 'Spain'],
        mercedes: { name: 'Mercedes', color: '#27F4D2', points: [43, 90, 133, 170, 219, 219] },
        ferrari: { name: 'Ferrari', color: '#F91536', points: [27, 54, 82, 104, 147, 172] },
        mclaren: { name: 'McLaren', color: '#FF8700', points: [18, 28, 48, 68, 106, 106] },
        redBull: { name: 'Red Bull Racing', color: '#3671C6', points: [10, 13, 19, 32, 57, 57] },
        alpine: { name: 'Alpine', color: '#FF87BC', points: [10, 13, 20, 27, 35, 35] },
        racingBulls: { name: 'Racing Bulls', color: '#5E8FAA', points: [7, 11, 14, 18, 21, 21] },
        haas: { name: 'Haas F1 Team', color: '#B6BABD', points: [12, 17, 24, 31, 19, 19] },
        williams: { name: 'Williams', color: '#64C4FF', points: [6, 6, 12, 16, 7, 7] },
        audi: { name: 'Audi', color: '#C92D4B', points: [3, 4, 4, 4, 2, 2] }
    }
};
