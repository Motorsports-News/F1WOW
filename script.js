...
const CHAMPIONSHIP_DATA_2026 = {
    driver: {
        ...
        kimiAntonelli: { name: 'Kimi Antonelli', team: 'Mercedes', color: '#27F4D2', points: [18, 47, 75, 100, 130, 130] },
        lewisHamilton: { name: 'Lewis Hamilton', team: 'Ferrari', color: '#F91536', points: [12, 33, 54, 79, 103, 128] },
        georgeRussell: { name: 'George Russell', team: 'Mercedes', color: '#27F4D2', points: [25, 51, 72, 91, 106, 106] },
        charlesLeclerc: { name: 'Charles Leclerc', team: 'Ferrari', color: '#F91536', points: [15, 34, 50, 70, 75, 87] },
        landoNorris: { name: 'Lando Norris', team: 'McLaren', color: '#FF8700', points: [10, 15, 28, 43, 58, 68] },
        oscarPiastri: { name: 'Oscar Piastri', team: 'McLaren', color: '#FF8700', points: [8, 13, 26, 41, 56, 68] },
        maxVerstappen: { name: 'Max Verstappen', team: 'Red Bull', color: '#3671C6', points: [6, 8, 15, 25, 40, 55] },
        pierreGasly: { name: 'Pierre Gasly', team: 'Alpine', color: '#FF87BC', points: [8, 9, 20, 30, 38, 48] },
        isackHadjar: { name: 'Isack Hadjar', team: 'Red Bull', color: '#3671C6', points: [4, 5, 10, 15, 20, 34] },
        liamLawson: { name: 'Liam Lawson', team: 'RB', color: '#5E8FAA', points: [5, 8, 12, 18, 23, 28] },
        francoColapinto: { name: 'Franco Colapinto', team: 'Alpine', color: '#FF87BC', points: [2, 4, 8, 12, 15, 16] },
        oliverBearman: { name: 'Oliver Bearman', team: 'Haas', color: '#B6BABD', points: [10, 17, 22, 27, 27, 18] },
        carlosSainz: { name: 'Carlos Sainz', team: 'Williams', color: '#64C4FF', points: [4, 2, 8, 12, 12, 6] },
        alexAlbon: { name: 'Alexander Albon', team: 'Williams', color: '#64C4FF', points: [2, 4, 6, 8, 8, 5] },
        estebanOcon: { name: 'Esteban Ocon', team: 'Haas', color: '#B6BABD', points: [2, 0, 2, 4, 6, 3] },
        gabrielBortoleto: { name: 'Gabriel Bortoleto', team: 'Audi', color: '#C92D4B', points: [1, 2, 2, 2, 2, 2] },
        fernandoAlonso: { name: 'Fernando Alonso', team: 'Aston Martin', color: '#229971', points: [0, 1, 1, 1, 1, 1] }
    },
    constructor: {
        rounds: ['Australia', 'China', 'Japan', 'Miami', 'Canada', 'Spain'],
        mercedes: { name: 'Mercedes', color: '#27F4D2', points: [43, 98, 147, 191, 236, 236] },
        ferrari: { name: 'Ferrari', color: '#F91536', points: [27, 67, 104, 149, 178, 215] },
        mclaren: { name: 'McLaren', color: '#FF8700', points: [18, 28, 54, 84, 114, 136] },
        redBull: { name: 'Red Bull Racing', color: '#3671C6', points: [10, 13, 25, 40, 60, 89] },
        alpine: { name: 'Alpine', color: '#FF87BC', points: [10, 13, 28, 42, 53, 64] },
        rb: { name: 'Racing Bulls', color: '#5E8FAA', points: [5, 12, 22, 32, 39, 44] },
        haas: { name: 'Haas F1 Team', color: '#B6BABD', points: [12, 17, 24, 31, 33, 21] },
        williams: { name: 'Williams', color: '#64C4FF', points: [6, 6, 14, 20, 20, 11] },
        audi: { name: 'Audi', color: '#C92D4B', points: [3, 4, 4, 4, 4, 4] },
        astonMartin: { name: 'Aston Martin', color: '#229971', points: [0, 1, 1, 1, 1, 1] }
    }
};
