...
body = '''    <main class="main" id="main">
        ...
        <article class="article-full">
            ...
            <div class="article-content">
                ...
                <div class="article-section">
                    <h2><span class="section-icon">\U0001F49A</span> Alonso's Breakthrough: First Q2 of the Season</h2>
                    <p>Amid the front-running drama, one of the most heartening stories of the day unfolded in the midfield: <strong>Fernando Alonso reached Q2 for the first time all season.</strong> For a two-time world champion grinding through one of the toughest campaigns of his career with Aston Martin, escaping Q1 was far more than a footnote &mdash; it was a genuine breakthrough and a long-awaited flash of light for a driver who has extracted everything and more from a difficult car all year.</p>
                    <p>He ultimately qualified 16th, eliminated at the end of Q2, but the result belied its meaning. Getting the Aston into the second segment for the first time in 2026 is a marker the team can build on, and a reminder that Alonso's relentless one-lap commitment has not dimmed. On a day of headline poles and title-fight subplots, it was a quiet victory worth celebrating.</p>
                </div>
