...
- **2026-08-25** — Depth reintroduction done and visually verified (hover states on hero CTA pills now show a soft amber-tinted lift shadow instead of nothing). The `.dz-*`/`.cst-*` component consolidation and GSAP motion addition are next.
